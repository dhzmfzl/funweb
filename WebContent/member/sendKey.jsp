...
try{
    ...
    msg.setSubject("비밀번호 인증번호", "UTF-8"); // 제목
     
    Address fromAddr = new InternetAddress("psnproject88@gmail.com");
    ...
    msg.setContent(code, "text/html;charset=UTF-8"); // 내용과 인코딩
