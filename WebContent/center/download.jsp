...
if(count!=0){
	boardList2=bdao.getBoardList(startRow, pageSize,boardNum);
}
  ...
  //한화면에 보여줄 페이지 개수 설정
   ...
   // 한화면에 보여줄 시작페이지번호 구하기   -  /  *  +
	...
	if(startPage > pageBlock){
		%><a href="download.jsp?pageNum=<%=startPage-pageBlock%>">Prev</a><%
	}
	// 1 2 3 4 ...10
	...
	if(endPage < pageCount){
		%><a href="download.jsp?pageNum=<%=startPage+pageBlock%>">Next</a><%
	}
}
%>
</div>
