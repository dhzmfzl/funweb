...
<tr><td class="twirte">글쓴이</td><td><input type="text" name="name" value="<%=id%>" readonly></td></tr>
<tr><td class="twirte">비밀번호</td><td><input type="password" name="pass"></td></tr>
<%if(boardNum==2){ %>
<tr><td class="twirte">파일</td><td><input type="file" name="file"></td></tr> <!-- file 추가 -->
<%} %>
<tr><td class="twirte">제목</td><td><input type="text" name="subject"></td></tr>
<tr><td class="twirte">글내용</td>
